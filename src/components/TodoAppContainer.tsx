...
const TodoAppContainer = () => {
  ...
  const filteredTodos = todos
    ...
    return (
  <div className="min-h-screen bg-gray-50 flex items-center justify-center px-2 py-4">
    <div className="w-full max-w-5xl bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
      <h2 className="text-xl font-semibold mb-3 text-center text-gray-700">Todo App</h2>
      ...
      <div className="flex flex-wrap justify-between items-center mb-3 gap-2 text-sm">
        <div className="flex items-center gap-2 text-gray-600">
          <span>Sorted by: <strong>{sortOrder === "asc" ? "Oldest First" : "Newest First"}</strong></span>
          <button
            onClick={() => setSortOrder((prev) => (prev === "asc" ? "desc" : "asc"))}
            className="px-2 py-1 border border-gray-300 rounded text-blue-600 hover:bg-blue-50"
